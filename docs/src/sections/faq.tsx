				...
				<div className="row">
					{[
						...
						[
							...
							'Из-за невозможности оплаты разработчика Apple, поддержки iOS пока нет, также пока не найден способ удобно устанавливать приложения со сторонних магазинов на iOS. Если эти проблемы решатся, Udnevka сразу станет доступен на iOS!',
						],
						[
